function tinhThue(){
    ...
    if(thuNhap > 0 && thuNhap <= 60){
        ...
        document.getElementById("txtThue").innerHTML = "Thuế cần phải trả là : " + thueTNCN + " (triệu)";
        ...
        thueTNCN = (thuNhap - 4 - (soNguoi * 1.6)) * 0.20;
        document.getElementById("txtThue").innerHTML = "Thuế cần phải trả là : " + thueTNCN + " (triệu)";
    }else if(thuNhap > 384 && thuNhap <= 624){
        thueTNCN = (thuNhap - 4 - (soNguoi * 1.6)) * 0.25;
        document.getElementById("txtThue").innerHTML = "Thuế cần phải trả là : " + thueTNCN + " (triệu)";
    }else if(thuNhap > 624 && thuNhap <= 960){
        thueTNCN = (thuNhap - 4 - (soNguoi * 1.6)) * 0.30;
        document.getElementById("txtThue").innerHTML = "Thuế cần phải trả là : " + thueTNCN + " (triệu)";
    }else if(thuNhap > 960){
        thueTNCN = (thuNhap - 4 - (soNguoi * 1.6)) * 0.35;
        document.getElementById("txtThue").innerHTML = "Thuế cần phải trả là : " + thueTNCN + " (triệu)";
    }else{
        document.getElementById("txtThue").innerHTML = "Số tiền nhập vào không hợp lệ: Xin nhập lại"
    }
...
function showInp(){
    ...
    switch (loaiKH){
        case 'Doanh nghiệp':
            ...
            console.log("block:" + loaiKH);
            // tienCap = 15 + 75 + (soKetNoi * 5) + (50 * soKenh);
        break;
        case 'Cá nhân':
        ...
        default:
            document.getElementById("content").style.display = 'none';
            console.log("none:" + loaiKH);
    }
    // document.getElementById("txtThue2").innerHTML = "Số tiền cần phải trả là: " + tienCap;
    return loaiKH,soKetNoi,soKenh;
}
...
function tinhTienCap(){
    ...
    switch (loaiKH){
        case 'Doanh nghiệp':
            ...
            document.getElementById("txtThue2").innerHTML = "Số tiền khách hàng " + hoVaTen2 + " cần phải trả là: " + tienCap;
            }else if(soKetNoi > 10){
                tienCap = 15 + 75 + (soKetNoi - 10) * 5 + (50 * soKenh)
                document.getElementById("txtThue2").innerHTML = "Số tiền khách hàng " + hoVaTen2 + " cần phải trả là: " + tienCap;
            }else{
                document.getElementById("txtThue2").innerHTML = "Bạn nhập chưa đúng định dạng của Số Kết Nối, mời nhập lại."
            }
        break;
        case 'Cá nhân':
            tienCap = 4.5 + 20.5 + (7.5 * soKenh);
        ...
        break;
        default:
            document.getElementById("txtThue2").innerHTML = "Bạn chưa chọn loại khách hàng";
    }
